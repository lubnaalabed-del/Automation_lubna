...
test('test', async ({ page }) => {
  ...
  //Individual therapy / Aman package / card payment method
  ...
  await page.getByTestId('have-treatment-before-1').first().click();
  await page.getByTestId('psychiatric-medications-1').first().click();
